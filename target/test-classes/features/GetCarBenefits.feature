...
Feature: Testing GET Car Benefits API
  ...
  Scenario: Testing GET Car Benefits API
    ...
    When user configures stubs for nino CS700100 for taxyear 2018 for getCarBenefits with GET request
    Then the server should handle get for nino CS700100 for taxyear 2018 for getCarBenefits and return success status
